              ...
              <div className="relative h-full w-full px-6 pt-6 sm:px-8 sm:pt-8">
                ...
                <div className="relative z-10 flex h-full flex-col justify-between text-white">
                  ...
                  <button
                    ...
                    className="mt-5 block max-w-[290px] w-[78%] rounded-[20px] border border-[rgba(255,255,255,0.12)] bg-[rgba(15,20,28,0.15)] px-5 py-5 text-left text-white transition duration-250 ease-in-out hover:-translate-y-0.5 active:scale-[0.98]"
                    style={{

  ...
  return (
    <>
      <button
        ...
        aria-label="Действия со счётчиком"
        aria-expanded={open}
      >
        ⋮
      </button>
      ...
      {open &&
        createPortal(
          <div
            ref={menuRef}
            className="fixed z-[120] min-w-[160px] overflow-hidden rounded-2xl border border-[var(--app-border)] bg-[var(--app-surface)] py-1 shadow-xl"
